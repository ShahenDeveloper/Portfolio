    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center my-20 relative z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <h2 className="uppercase font-bold tracking-widest text-sm  text-center text-blue-100 max-w-80">
            Dynamic Web Magic with Next.js
          </h2>
          <TextGenerateEffect
            className="text-center font-bold text-[30px] md:text-4xl lg:text-5xl"
            words="Transforming Concepts into Seamless User Experiences"
          />
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-xl">
            Hi, I&apos;m Shaheen, a Web Developer based in Bangladesh{" "}
          </p>
          <a href="#projects">
            <Button
              title="Show my work"
